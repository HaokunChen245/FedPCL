...
python haokun/main.py --alg fedavg --lr 0.005 --dataset office --num_users 5 --rounds 200 --num_bb 1 --feature_iid 1 --label_iid 0 --alpha 1 >office_fedavg_filn_1bb_5u_a1.log
python haokun/main.py --alg fedavg --lr 0.005 --dataset office --num_users 5 --rounds 200 --num_bb 3 --feature_iid 1 --label_iid 0 --alpha 1 >office_fedavg_filn_3bb_5u_a1.log
python haokun/main.py --alg fedavg --lr 0.005 --dataset office --num_users 5 --rounds 200 --num_bb 1 --feature_iid 0 --label_iid 0 --alpha 1 >office_fedavg_fnln_1bb_5u_a1.log
python haokun/main.py --alg fedavg --lr 0.005 --dataset office --num_users 5 --rounds 200 --num_bb 3 --feature_iid 0 --label_iid 0 --alpha 1 >office_fedavg_fnln_3bb_5u_a1.log
python haokun/main.py --alg fedavg --lr 0.005 --dataset office --num_users 5 --rounds 200 --num_bb 1 --feature_iid 0 --label_iid 1 --alpha 1 >office_fedavg_fnli_1bb_5u_a1.log
python haokun/main.py --alg fedavg --lr 0.005 --dataset office --num_users 5 --rounds 200 --num_bb 3 --feature_iid 0 --label_iid 1 --alpha 1 >office_fedavg_fnli_3bb_5u_a1.log
